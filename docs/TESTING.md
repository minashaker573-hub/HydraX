...
| Website | Parsing, assets, anchors, CSP compatibility, unmeasured-claim guard, request flow | `npm run check:website` |
| Admin console | Parsing, mount prefix, safe rendering, credential handling | `npm run check:admin` |
